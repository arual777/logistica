create database EmpresaLogistic;
use EmpresaLogistic;
...
id_Tractor int not null auto_increment,
...
id_Semi int not null auto_increment,
id_TipoSemi int not null,
...
primary key (id_Service),
foreign key (id_Tractor) references Tractor (id_Tractor),
